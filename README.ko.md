...
| **Layer 3** — LLM 판정 | Cerebras Llama 3.3 70B 최종 판정 + 의도 정합성 검사 | ~200 ms, 비동기 |
...
Layer 1과 Layer 2의 결과가 모호한 경우, 고속 LLM(기본값: Cerebras의 Llama 3.3 70B)이 최종 판정을 내립니다. 도구 호출이 사용자 의도와 일치하는지 확인하는 의도 정합성 검사도 지원합니다.
