...
| **الطبقة 3** | حَكَم LLM (Cerebras GPT-OSS 120B) | ~200 مللي ثانية | غير متزامن. الحكم النهائي للحالات الغامضة |
...
**الطبقة 3 — حَكَم LLM:** يستخدم Cerebras افتراضيًا (نموذج `gpt-oss-120b`، حوالي 300 مللي ثانية). يدعم أيضًا واجهات API المتوافقة مع OpenAI و Anthropic. يُستدعى فقط عندما تكون درجة الثقة بين 0.5 و 0.7. يتضمن التحقق من توافق النية (intent alignment) لاستدعاءات الأدوات.
